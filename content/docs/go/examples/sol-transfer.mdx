...
The most basic Solana transaction: move SOL from one account to another. This is a good first test to verify your `litesvm-go` setup works before testing more complex program logic.
...
This covers the simplest transaction type. For testing with custom programs, see [Program Testing](/docs/go/examples/program-testing). For time-dependent logic, see [Time-Based Testing](/docs/go/examples/time-based).
